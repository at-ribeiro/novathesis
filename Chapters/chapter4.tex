...
A foundational \gls{VR} application was required to construct the \gls{VE}, which in turn necessitated the use of a game engine.
This section describes the architecture and the tools used for this application, 
which are presented in Figure~\ref{fig:architecture}.
...
variants and the UI elements needed for the study's tasks, as well as a streamlined integration of these implemented objects into the \gls{VR} 
...
a custom shader is utilized (Figure~\ref{fig:portal-previews}). The shader receives as input the render texture generated by the portal cameras.
...
\begin{figure}[p]
  \centering
    % First row: (a) and (b)
    \begin{subfigure}{\textwidth} % Smaller width for each subfigure
       \includegraphics[width=\linewidth]{NOVAthesisFiles/Images/screenshots/preview-a.drawio.png}
        \caption{When the player is in Room A, the cameras of portal B will be used to render the screens of Portal A, so that what is 
        displayed in Portal A is the view the player would have if positioned at the same location and rotation relative to Portal B}
        \label{fig:preview-a}
    \end{subfigure}
    \begin{subfigure}{\textwidth} % Smaller width for each subfigure
        \includegraphics[width=\linewidth]{NOVAthesisFiles/Images/screenshots/preview-b.drawio.png}
        \caption{When the player passes the portal, the cameras of portal A will be used to render the screens of Portal B, so that what is 
        displayed in Portal B is the view the player would have if positioned at the same location and rotation relative to Portal A}
        \label{fig:preview-b}
    \end{subfigure}
  \caption[Unity scene showing how portal screens are rendered]
  {Unity scene exemplifying how portals render their previews}
  \label{fig:portal-previews}
\end{figure}
...
portal design are present in Figure~\ref{fig:trad-portal-comp}.
...
placed within the environment, as described in Section~\ref{sec:mov-portal-design}. Figure~\ref{fig:mov-portal-sc} demonstrates the implemented 
interaction sequence and the component structure of this portal variant is shown in Figure~\ref{fig:mov-portal-comp}.
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{.45\linewidth}
    \centering
    \includegraphics[width=\linewidth]{NOVAthesisFiles/Images/screenshots/mov-portal-a.png}
    \caption{} % just auto-label (a)
    \label{fig:mov-portal-a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{.45\linewidth}
    \centering
    \includegraphics[width=\linewidth]{NOVAthesisFiles/Images/screenshots/mov-portal-b.png}
    \caption{} % just auto-label (b)
    \label{fig:mov-portal-b}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{.45\linewidth}
    \centering
    \includegraphics[width=\linewidth]{NOVAthesisFiles/Images/screenshots/mov-portal-c.png}
    \caption{} % just auto-label (c)
    \label{fig:mov-portal-c}
  \end{subfigure}

  \caption[Movable Portal interaction sequence]%
  {The interaction sequence for the Movable Portal: 
   (a) Initially, the portal is placed against the wall with a rotated continuous preview. 
   (b) The user grabs the portal with their virtual hand through the golden-handle. 
   A green valid area is displayed to show the user where they may place the portal. 
   (c) The user places the portal by letting go of the golden-handle. 
   The preview rotates to match the position of the user.}
...
\begin{figure}[t]
  ...
  \begin{subfigure}[b]{.45\linewidth}
    \centering
    \includegraphics[width=\linewidth]{NOVAthesisFiles/Images/screenshots/CaptureDoorA.PNG}
    \caption{} % just auto-label (a)
    \label{fig:int-door-a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{.45\linewidth}
    \centering
    \includegraphics[width=\linewidth]{NOVAthesisFiles/Images/screenshots/CaptureDoorClosed.PNG}
    \caption{} % just auto-label (b)
    \label{fig:int-door-b}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{.45\linewidth}
    \centering
    \includegraphics[width=\linewidth]{NOVAthesisFiles/Images/screenshots/CaptureDoorC.PNG}
    \caption{} % just auto-label (c)
    \label{fig:int-door-c}
  \end{subfigure}
  
  \caption[Interactive Door interaction sequence]%
  {The interaction sequence for the Interactive Door: 
   (a) From a distance, the door is transparent, providing a clear preview to aid spatial awareness. 
   (b) As the user approaches, it becomes opaque, suggesting the need for direct interaction. 
   (c) The user opens the door by grabbing the handle and swinging it while the portal accompanies it, 
   creating the necessary clearance for the user to move safely into the next space.}
...
\begin{figure}[p]
  ...
  \begin{subfigure}[b]{\linewidth}
    \centering
    \includegraphics[width=.49\linewidth]{NOVAthesisFiles/Images/screenshots/Revolving Door Invisible.PNG}
    \includegraphics[width=.49\linewidth]{NOVAthesisFiles/Images/screenshots/rev-A.png}
    \caption{From a distance, the transparent panels provide a preview of the next room.}
    \label{fig:rv-door-a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{\linewidth}
    \centering
    \includegraphics[width=.49\linewidth]{NOVAthesisFiles/Images/screenshots/Capture Revolving.PNG}
    \includegraphics[width=.49\linewidth]{NOVAthesisFiles/Images/screenshots/rev-B.png}
    \caption{The user initiates the transition by walking into a compartment, pushing the door.}
    \label{fig:rv-door-b}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{\linewidth}
    \centering
    \includegraphics[width=.49\linewidth]{NOVAthesisFiles/Images/screenshots/Capture Revolving C.png}
    \includegraphics[width=.49\linewidth]{NOVAthesisFiles/Images/screenshots/rev-C.png}
    \caption{After pushing the door and completing a 180-degree turn, the user comes out on the other side.}
    \label{fig:rv-door-c}
  \end{subfigure}

  \caption[Revolving Door interaction sequence]%
  {The interaction sequence for the Revolving Door.}
...
\section{User Interface: Case Study}
\label{sec:ui}
...
the evaluation of the portal variants. A separate researcher interface, shown only on the desktop monitor, 
...
were developed, allowing users to perform this task immediately after experiencing the portal variant, without leaving the \gls{VE} (Figure~\ref{fig:likert-scale-ui}).
...
\begin{figure}[t]
    \centering
     \includegraphics[width=.75\textwidth]{NOVAthesisFiles/Images/screenshots/researcher-ui.png}
...
\begin{figure}[t]
    \centering
     \includegraphics[width=0.75\textwidth]{NOVAthesisFiles/Images/screenshots/pointing-ray.png}
