...
In order to compare the developed portal techniques and answer the Research Questions proposed on Section~\ref{sec:objectives-and-researh-questions},
...
This chapter begins with Section~\ref{sec:protocol}, which describes the study protocol and experimental procedure adopted to evaluate 
the proposed portal techniques. 
...
This chapter presented the evaluation of the developed portal-based locomotion techniques through a user study with 31 
participants. 
...
post-session open-ended questions, participant rankings of portal techniques, and spontaneous comments or 
...
questions, outlining the strengths and limitations of each technique and their implications for \gls{VR} navigation 
design.
