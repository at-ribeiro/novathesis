...
To overcome these constraints, researchers have explored spatial manipulation techniques such as Impossible Spaces, 
...
though others justified their preference by valuing the additional control of Movable Portals or the continuous redirection of Revolving Doors. 
...
Regarding the third research question -- \textbf{(Q3) What are the navigation benefits of each portal design in small spaces?} -- 
...
\begin{itemize}
    ...
    such as collaborative tasks, storytelling experiences, or outdoor environments, to assess generalizability and context-dependent 
    advantages.

    \item \textbf{Refinement and innovation of portal designs} -- Design and test new portal variants or hybrid techniques that 
    address usability and spatial perception limitations, minimizing the usability costs introduced by the proposed portal variants.
...
In summary, this thesis contributes to the ongoing exploration of navigation techniques for \glsfirst{VR} by proposing, 
implementing, and evaluating three novel portal designs that expand upon the limitations of traditional approaches. 
The findings demonstrate that while each design involves trade-offs between usability, naturalness, and spatial continuity, 
they collectively broaden the toolkit available for \gls{VR} designers seeking to deliver immersive experiences within physically 
constrained spaces. We believe that by highlighting both the benefits and challenges of these alternatives, this work provides practical 
guidance for the design of future \gls{VR} applications and lays the foundation for further research on this topic.